...
const faqItems = [
  ...
  },
  {
    ...
    a: "Для побутових деталей та автокріплень зазвичай ідеально підходить PETG (ударостійкий та міцний). Для високих температур (до 95°C) — ABS. Для декору — PLA+. Ми завжди підкажемо найкращий варіант перед запуском.",
  },
  {
